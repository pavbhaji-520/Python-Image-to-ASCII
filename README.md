...
* ### Run one of the following commands based on use case:
    * For black and white (using pixel brightness): `python black_and_white.py`
    * For full color (without pixel brightness): `python color2.py`
    * For full color (with pixel brightness): `python color_only.py`
 
      (In my opinion, full color without pixel brightness looks the best)
